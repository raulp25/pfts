...
const Algorithms = ({ project, socials }:Props) => {  
            ...
            <div className='lg:mx-[109px] lg:max-w-[517px] w-full'>
                <main className='w-10/12 lg:w-[517px] main-about lg:px-4 pt-5 pb-20 lg:py-7 mx-auto text-white'>
                        <article className='mt-3 flex flex-col'>
                            ...
                            This document serves as a memory of my learning process and passion for knowledge.  Even tho you can learn any algorithm anywhere in the internet, I would suggest this book as a must read since it explains pretty interesting things. 
                            </p>
                        </article>
