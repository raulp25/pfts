                ...
                <div className='lg:mx-[109px] lg:max-w-[517px] w-full '>
                    <main className='w-10/12 lg:w-[517px] main-about lg:px-4 pt-5 pb-20 lg:py-7 mx-auto text-white'>
                            <article className='mt-3 flex flex-col'>
                                ...
                                Chat Live through <span className='text-[#72FFFF] hyphens-auto'>sockets</span> technology. Register securely with firebase and retrieve your messages with mongoDB.
                                </p>
                            </article>
                            ...
                            <article className='mt-7' >
                                <ul>
                                    ...
                                    <li className='list-disc  h-fit mr-4 inline-block  px-1  pt-0 pb-0 mt-0 mb-0 align-text-bottom text-end whitespace-nowrap  rounded bg-green-rgba font-bold text-green-text-rgba text-xs'>User: testuser</li>
                                    <li className='list-disc  h-fit mr-4 inline-block  px-1  pt-0 pb-0 mt-0 mb-0 align-text-bottom text-end whitespace-nowrap  rounded bg-green-rgba font-bold text-green-text-rgba text-xs'>Pass: 12345678</li>
                                </ul>
                            </article>
