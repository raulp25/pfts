            ...
            <div className='lg:mx-[109px] lg:max-w-[517px] w-full'>
                <main className='w-10/12 lg:w-[517px] main-about lg:px-4 pt-5 pb-20 lg:py-7 mx-auto text-white'>
                        <article className='mt-3 flex flex-col'>
                            ...
                            Ready to <span className='text-[#72FFFF] hyphens-auto'>mint</span> nft's from the blockchain? I'm sure you are. This tailor spec NFT dapp lets you <span className='text-[#72FFFF]'>mint</span> nft's from my personal collection or any collection connected through this app, thirdWeb and crypto networks. 
                            </p>
                            <p className='mt-1 text-justify indent-5 text-base font-normal .main-about'>
                            Blockchain is the future, Reddit and Starbucks are just proof of that.  
                            </p>
                        </article>
